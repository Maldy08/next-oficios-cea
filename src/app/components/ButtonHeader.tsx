...
export const ButtonHeader = ({ user }: ButtonHeaderProps) => {
  ...
  return (
    <>
      ...
      {open && (
        <ul
          className="absolute w-15 py-1 mt-2 bg-gray-100 border border-gray-200 
        ...
        >
          <li>
            <a
              ...
              className="block px-3 py-1 text-xs text-gray-700 hover:bg-gray-200 dark:text-gray-200 dark:hover:bg-gray-600"
            >
              Cerrar Sesión
            </a>
          </li>
